...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai nhất lớp CTQP :<<<<<<< ";
...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                width: 900,
                confirmButtonText: 'Okeeeee lun <3',
                background: '#fff url("img/iput-bg.jpg")',
                ...
                onClose: () => {
                    window.location = 'https://www.facebook.com/profile.php?id=100025245634715&epa=SEARCH_BOX';
                  }
            })
        }
    })
