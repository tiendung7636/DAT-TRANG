...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai vlone :<<<<<<< ";
...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                width: 900,
                confirmButtonText: 'Okee lun <3',
                background: '#fff url("../img/iput-bg.jpg")',
                title: 'Tớ biết mà ^^ Yêu cậu lắm 300.000',
                text: "Tối nay tớ qua đón cậu đi chơi nhaaaaaaaaa :v Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/profile.php?id=100025245634715';
                  }
            })
        }
    })
